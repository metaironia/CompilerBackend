...
#define IR_EMIT_CMD_JUMP_NOT_EQUAL_                                   IntReprEmit (interm_repr, "jump not equal",  IR_CMD_JMP_NOT_EQUAL,  IR_OP_NO_OPERAND, NOT_A_VALUE, NAN, IR_POISON,     false, IR_OP_NO_OPERAND, NOT_A_VALUE,       NAN,     IR_POISON,    false, NULL, IR_POISON, IR_POISON, true)

#define IR_EMIT_CMD_JUMP_LESS_EQ_                                     IntReprEmit (interm_repr, "jump less eq",    IR_CMD_JMP_LESS_EQ,    IR_OP_NO_OPERAND, NOT_A_VALUE, NAN, IR_POISON,     false, IR_OP_NO_OPERAND, NOT_A_VALUE,       NAN,     IR_POISON,    false, NULL, IR_POISON, IR_POISON, true)
